...
export const protobufPackage = 'nikolaystoev.checkers.checkers'
...
export class QueryClientImpl implements Query {
  ...
  StoredGame(request: QueryGetStoredGameRequest): Promise<QueryGetStoredGameResponse> {
    ...
    const promise = this.rpc.request('nikolaystoev.checkers.checkers.Query', 'StoredGame', data)
  ...
  StoredGameAll(request: QueryAllStoredGameRequest): Promise<QueryAllStoredGameResponse> {
    ...
    const promise = this.rpc.request('nikolaystoev.checkers.checkers.Query', 'StoredGameAll', data)
  ...
  NextGame(request: QueryGetNextGameRequest): Promise<QueryGetNextGameResponse> {
    ...
    const promise = this.rpc.request('nikolaystoev.checkers.checkers.Query', 'NextGame', data)
